...
qqlim <- function(rawvector, outpath=NA, file=NA, size_point=0.75, saving=0, fulltitle=NULL, fullcut=1){
...
gg[[1]] <- qqlim(unlist(newp$P), fulltitle='grill', saving=0, size_point=0.75, fullcut=0)


claude <- function(trait, env){
  
  # needed for toTitleCase in ttitle remake
  library(tools)
  ...
  #qqlim funciton call
  newhead <- qqlim(unlist(newp$P), fulltitle=newtitle, saving=0, size_point=0.75, fullcut=1)
