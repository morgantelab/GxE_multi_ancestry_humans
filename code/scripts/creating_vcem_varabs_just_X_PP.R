...
model <- BGLR(y=y, ETA=ETA, nIter=iter, burnIn=burnin, thin=thin, verbose=verb, saveAt=paste(scratch, '/PP_X1_run_', sep=''))
...
# ### intercept ###
# zz0 <- read.table(paste(scratch, '/PP_X_run_mu.dat', sep=''), header=F); colnames(zz0) <- "int"
#
# print("zz0 created")
#
