...
B1 <- read.table(paste(scratch, '/SP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter_ETA_X1_b.dat', sep=''), header=T)

print("B1 done now B2")

### additive genetic random effects ###
B2 <- read.table(paste(scratch, '/SP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter_ETA_X2_b.dat', sep=''), header=T)

B3 <- readBinMat(paste(scratch, '/SP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter_ETA_G_b.bin', sep=''))

B4 <- readBinMat(paste(scratch, '/SP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter_ETA_E_b.bin', sep=''))

B5 <- readBinMat(paste(scratch, '/SP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter_ETA_GxE_b.bin', sep=''))
...
write.csv(varabs, file="/data2/morgante_lab/ukbiobank_projects/GxE_multi_ancestry/data/model/varabs_SP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter.csv", row.names=TRUE)
