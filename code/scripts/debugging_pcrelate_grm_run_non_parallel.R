...
mypcrelate_5pcs <- pcrelate(diversity_genoData, pcs = pcair_results$vectors[,1:5],ibd.probs = FALSE, training.set = pcair_results$unrels, BPPARAM = BiocParallel::SerialParam())

# Save the PC-Relate results
saveRDS(mypcrelate_5pcs, file = "/data2/morgante_lab/ukbiobank_projects/GxE_multi_ancestry/data/filtered_chr/test_mypcrelate_no_parallel.RDS")
