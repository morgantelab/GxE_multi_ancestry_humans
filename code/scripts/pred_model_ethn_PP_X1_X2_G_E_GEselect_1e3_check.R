...
GEselect_file <- "/data2/morgante_lab/ukbiobank_projects/GxE_multi_ancestry/data/gwas_snp_env/Hadamard_GRM_Ancestryasian_PP_0.001.RData"

# Output file name
output_file <- paste0(output_dir, "/PREDs_PP_ethn_asianpval0.001_X1_X2_G_E_GEselect_check.csv")
...
model <- BGLR(y = y, ETA = ETA, nIter = iter, burnIn = burnin, thin = thin, verbose = verb, 
              saveAt = paste0(scratch_dir, "/PREDs_PP_ethn_asian_X1_X2_G_E_GEselect"))
