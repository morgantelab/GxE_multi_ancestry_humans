...
generate_and_save_plots <- function(VCEm_file_path, varabs_file_path, identifier) {
  ...
  # Save the VCEm plot
  ggsave(paste0("with_mean_G_trace_plots_intercept_and_variances_", identifier, ".png"), plot = intercept_variances_plot, width = 10, height = 6)
  ...
  ggsave(paste0("with_mean_G_trace_plots_variance_components_", identifier, ".png"), plot = variances_plot, width = 10, height = 6)
}
