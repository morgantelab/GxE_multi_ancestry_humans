...
generate_and_save_plots <- function(VCEm_file_path, varabs_file_path, identifier) {
  ...
  # Save the VCEm plot
  ggsave(paste0("with_mean_G_pcs_trace_plots_intercept_and_variances_", identifier, ".png"), plot = intercept_variances_plot, width = 10, height = 6)
  ...
  varabs_melted2$Component <- factor(varabs_melted2$Component, levels = c("V_X", "V_G"))
  ...
  ggsave(paste0("with_mean_G_pcs_trace_plots_variance_components_", identifier, ".png"), plot = variances_plot, width = 10, height = 6)
}
