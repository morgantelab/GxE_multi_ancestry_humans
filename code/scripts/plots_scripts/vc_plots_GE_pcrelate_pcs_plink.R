...
#   DP_pcrelate = "/data2/morgante_lab/ukbiobank_projects/GxE_multi_ancestry/data/model/VCEm_DP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter.csv",
#   SP_pcrelate = "/data2/morgante_lab/ukbiobank_projects/GxE_multi_ancestry/data/model/VCEm_SP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter.csv",
#   PP_pcrelate = "/data2/morgante_lab/ukbiobank_projects/GxE_multi_ancestry/data/model/VCEm_PP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter.csv"
# )

varabs_file_paths <- list(
  DP_pcrelate = "/data2/morgante_lab/ukbiobank_projects/GxE_multi_ancestry/data/model/varabs_DP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter.csv",
  SP_pcrelate = "/data2/morgante_lab/ukbiobank_projects/GxE_multi_ancestry/data/model/varabs_SP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter.csv",
  PP_pcrelate = "/data2/morgante_lab/ukbiobank_projects/GxE_multi_ancestry/data/model/varabs_PP_pcrelate_run_GE_pcrelate_pcs_plink_higher_iter.csv"
)
...
generate_and_save_plots <- function(varabs_file_path, identifier) {
  ...
  #
  # # Save the VCEm plot
  # ggsave(paste0("with_mean_GE_pcrelate_std_pcs_trace_plots_intercept_and_variances_", identifier, ".png"), plot = intercept_variances_plot, width = 10, height = 6)
  #
  ...
  varabs_melted2$Component <- factor(varabs_melted2$Component, levels = c("V_X1","V_X2", "V_G", "V_E", "V_GxE"))
  ...
  ggsave(paste0("with_mean_GE_pcrelate_std_pcs_trace_plots_variance_components_", identifier, ".png"), plot = variances_plot, width = 10, height = 6)
}
